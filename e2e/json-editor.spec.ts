...
test.describe('JSON Editor E2E Tests', () => {
  ...
  test('should format JSON successfully', async ({ page }) => {
    ...
    await expect(page.locator('h4:has-text("JSON Formatted")').first()).toBeVisible({ timeout: 5000 });
    
    // Wait for toast to disappear
    await expect(page.locator('h4:has-text("JSON Formatted")').first()).not.toBeVisible({ timeout: 10000 });
  });
  ...
  test('should minify JSON successfully', async ({ page }) => {
    ...
    // Should show success toast
    await expect(page.locator('h4:has-text("JSON Minified")').first()).toBeVisible({ timeout: 5000 });
    
    // Wait for toast to disappear
    await expect(page.locator('h4:has-text("JSON Minified")').first()).not.toBeVisible({ timeout: 10000 });
  });
  ...
  test('should validate JSON successfully', async ({ page }) => {
    ...
    // Should show success toast
    await expect(page.locator('h4:has-text("JSON Valid")').first()).toBeVisible({ timeout: 5000 });
    
    // Wait for toast to disappear
    await expect(page.locator('h4:has-text("JSON Valid")').first()).not.toBeVisible({ timeout: 10000 });
  });
  ...
  test('should show validation error for invalid JSON', async ({ page }) => {
    ...
    await expect(page.locator('h4:has-text("JSON Invalid")').first()).toBeVisible({ timeout: 5000 });
  ...
  test('should handle keyboard shortcuts', async ({ page }) => {
    ...
    await expect(page.locator('h4:has-text("File Saved")').first()).toBeVisible({ timeout: 5000 });
  ...
  test('should handle file drag and drop', async ({ page }) => {
    ...
    await page.evaluate((content) => {
      ...
      const dropZone = document.querySelector('.editor-container') || document.body;
  ...
  test('should handle multiple file operations in sequence', async ({ page }) => {
    // Wait for Monaco Editor to load
    await page.waitForSelector('.monaco-editor', { timeout: 10000 });
