...
function createBox(options = {}) {
  ...
  const Box2 = D(function Box3(inProps, ref) {
...
var maybeReactUseSyncExternalStore = C;
...
function RtlProvider(_ref) {
  ...
  return u(RtlContext.Provider, _extends({
...
function createCssVarsProvider(options) {
  ...
  const ColorSchemeContext = K(void 0);
  if (true) {
    ColorSchemeContext.displayName = "ColorSchemeContext";
  }
  const useColorScheme2 = () => {
    const value = x(ColorSchemeContext);
    if (!value) {
  ...
  function CssVarsProvider2(props) {
    ...
    const element = u(k, {
      children: [shouldGenerateStyleSheet && u(k, {
        children: [u(GlobalStyles, {
          styles: {
...
function createContainer(options = {}) {
  ...
  const Container2 = D(function Container3(inProps, ref) {
...
function createGrid(options = {}) {
  ...
  const GridOverflowContext = K(void 0);
  if (true) {
  ...
  const Grid2 = D(function Grid3(inProps, ref) {
    var _inProps$columns, _inProps$spacing, _ref, _inProps$rowSpacing, _ref2, _inProps$columnSpacin, _ref3, _disableEqualOverflow;
    const theme = useTheme_default();
    const themeProps = useThemeProps3(inProps);
    const props = extendSxProp(themeProps);
    const overflow2 = x(GridOverflowContext);
    const {
      className,
      children,
    ...
    let result = u(GridRoot, _extends({
      ref,
      as: component,
      ownerState,
      className: clsx_default(classes.root, className)
      ...
      children: O.map(children, (child) => {
        if (mn(child) && isMuiElement(child, ["Grid"])) {
    ...
    if (disableEqualOverflow !== void 0 && disableEqualOverflow !== (overflow2 != null ? overflow2 : false)) {
      result = u(GridOverflowContext.Provider, {
...
function createStack(options = {}) {
  ...
  const Stack2 = D(function Grid2(inProps, ref) {
    const themeProps = useThemeProps3(inProps);
    const props = extendSxProp(themeProps);
    const {
      component = "div",
...
function responsiveFontSizes(themeInput, options = {}) {
  ...
  const breakpointValues = breakpoints.map((x2) => theme.breakpoints.values[x2]);
  variants.forEach((variant) => {
...
function ThemeProvider3(_ref) {
  ...
  return u(ThemeProvider_default2, _extends({}, props, {
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-LDIVPWWQ.js.map
